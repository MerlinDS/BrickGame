// <copyright file="OldFigureController.cs" company="Near Fancy">
...
namespace BrickGame.Scripts.Figures
{
    ...
    /// <summary>
    /// OldFigureController - concrete figure controller.
    /// Provide controls for controlling figure matrix and position of the figure on playground.
    /// </summary>
    [DisallowMultipleComponent]
    [Obsolete("Class is deprecated. Use BrickGame.Scripts.Figures.FigureController instead")]
    public class OldFigureController : FigureFactory, IModelMessageResiver, IFigureMessageResiver
    {
        //================================       Public Setup       =================================
