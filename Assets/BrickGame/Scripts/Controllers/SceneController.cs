// <copyright file="SceneController.cs" company="Near Fancy">
...
{
    /// <summary>
    /// SceneController - controlling game modes.
    /// </summary>
    public class SceneController : GameManager
    {
        //================================       Public Setup       ================================
        [ShowOnly]
        ...
        public void Exit2Menu()
        {
            ...
            BroadcastNofitication(StateNotification.Close);
            //Load menu
